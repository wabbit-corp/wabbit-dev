...
try:
    from caching import Cashier, cache, NO_CACHE, _global_cashier_registry, _registry_lock, _cleanup_registered, get_cashier_instance, _cleanup_all_cashiers
except ImportError:
...
class TestCashier:
    ...
    def test_delete_by_fqn(self, cache_path):
        ...
        for k in keys_fqn1: cashier.set(k, fqn1, pickled_val)
        for k in keys_fqn2: cashier.set(k, fqn2, pickled_val)
