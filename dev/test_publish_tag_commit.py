...
def test_resolve_tag_commit_uses_existing_tag_commit() -> None:
    ...
    class DummyRepo:
        def __init__(self) -> None:
            self.tags = [SimpleNamespace(name="1.2.3", commit=existing_commit)]
    ...
    repo = DummyRepo()
    result = resolve_tag_commit(repo, "1.2.3", "demo-project")
...
def test_resolve_tag_commit_creates_tag_when_missing() -> None:
    ...
    repo = DummyRepo()
    result = resolve_tag_commit(repo, "2.0.0", "demo-project")
