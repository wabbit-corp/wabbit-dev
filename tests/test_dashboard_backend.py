...
def test_registry_status_is_error_when_registry_package_is_not_verified() -> None:
    status = _registry_status(
        "0.1.0",
        "pypi",
        "python-fx",
...
def test_overall_registry_visibility_prefers_ok_then_warn_then_error() -> None:
    ok_status = _registry_status("2.0.0", "maven-central", "pkg", "2.0.0", ("2.0.0",), True, ())
    warn_status = _registry_status("2.0.0", "jitpack", "pkg", "1.9.0", ("1.9.0",), True, ())
    error_status = _registry_status("2.0.0", "nuget", "pkg", None, (), True, ())
